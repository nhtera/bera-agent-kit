export const InfraredIBeraContractABI = [
  {
    inputs: [],
  ...
  { inputs: [], name: 'ValidatorForceExited', type: 'error' },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: 'SetDepositSignature',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint16', name: 'from', type: 'uint16' },
      {
        indexed: false,
        internalType: 'uint16',
        name: 'to',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_infrared', type: 'address' },
      {
        internalType: 'address',
        name: '_depositor',
        type: 'address',
      },
      { internalType: 'address', name: '_withdrawor', type: 'address' },
      {
        internalType: 'address',
        name: '_receivor',
        type: 'address',
  ...
  },
  {
    ...
    name: 'previewBurn',
    outputs: [
      { internalType: 'uint256', name: 'beraAmount', type: 'uint256' },
      {
        internalType: 'uint256',
        name: 'fee',
        type: 'uint256',
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'beraAmount', type: 'uint256' }],
    name: 'previewMint',
    outputs: [{ internalType: 'uint256', name: 'shares', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint16', name: 'to', type: 'uint16' }],
    name: 'setFeeDivisorShareholders',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
